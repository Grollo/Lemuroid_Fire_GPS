...
4. Google maps is your friend. You can right click any pin on the map and the first option is a coordinate pair you can copy (remember to change the comma to a semicolon). This menu also lets you measure distances. If no suitable pin exists, you can click anywhere on the map to create your own.
...
6. If possible, try to match the vibes. Ocean or coastal routes could be at the beach or other water feature, or Celadon City near a shopping mall. You know your area best, so try to have fun with it!

If you have created a file, please share it! Either make a pull request or just DM me.